...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.early_stop != None:
        ...
        earlystopping = EarlyStopping(patience=args.epochs, verbose=True, path = f'checkpoint/{args.store_name}/{args.dataset},{args.data_flag},{args.loss_type},{args.train_rule}.pt')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.early_stop  != None:
            ...
            if earlystopping.early_stop or epoch == args.epochs - 1: 
                ...
                print("Epochs :",epoch)
                model.load_state_dict(torch.load(f'checkpoint/{args.store_name}/{args.dataset},{args.data_flag},{args.loss_type},{args.train_rule}.pt'))  
