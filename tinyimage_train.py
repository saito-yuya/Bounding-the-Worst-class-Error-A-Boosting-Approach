...
from losses import *
from opts_tinyimage import parser
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    test_dataset = IMBALANETINYIMGNET(root='./data/tiny-imagenet-200/val/', imb_type=args.imb_type, imb_factor=args.imb_factor,
