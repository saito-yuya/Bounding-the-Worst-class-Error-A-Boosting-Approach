...
def get_args():
    ...
    parser.add_argument('--gamma', type = float, default=0.1995,help='gamma')
    parser.add_argument('--gpu', default="0",help='device')
    parser.add_argument('--root_log',type=str, default='tissue_log_OCO')
    parser.add_argument('--root_model', type=str, default='checkpoint_CE')
